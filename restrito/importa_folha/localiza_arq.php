...
$dt_Compentencia = implode('-',array_reverse(explode('/',date('t/m/Y', strtotime('-1 month')))));
                    ...
                    <div class="panel-body">
                      <form enctype="multipart/form-data" id="form1" name="form1" method="post" action="importa.php" target="_blank">
                        <table class="table-condensed">
                            ...
                            <tr>
                              <td>
                                Data Compentência no Financeiro:
                                <input type="date" class="form-control" name="data" value="<?php echo $dt_Compentencia ?>" id="data"/>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                Data para Vencimento no Financeiro:
                                <input type="date" class="form-control" name="data" value="<?php echo $dt ?>" id="data"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="center">
