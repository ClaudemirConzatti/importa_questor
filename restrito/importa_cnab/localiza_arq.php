            ...
            <div class="col-md-5 col-md-offset-4">
                <div class="panel-default panel panel-success">
                    ...
                    <div class="panel-body">
                      <form enctype="multipart/form-data" id="form1" name="form1" method="post" action="" target="_blank">
                        <table class="table-condensed">
                            ...
                            <tr>
                              <td>
                                ...
                                <select class="form-control" name="banco" id="banco" >
									<?php 
									  $sql="SELECT * FROM $base.bancos WHERE CodbancoCnab IS NOT NULL ORDER BY Banco";
									  $y   = mysqli_query($con_mysql,$sql);
									  while($x = mysqli_fetch_array($y)){
										echo' 
											<option value="'.$x['N'].'">'.$x['Banco'].'</option>
										';
									  }
									?>
                                </select>
                            ...
                            <tr>
                              <td align="center">
                                  <input type="button" name="button" id="button" value="Importar" onclick="pg();"  class="btn btn-info"/>
...
<script>
	...
	function pg(){
		...
		if(itemSelecionado=='BRADESCO'){
			pagina='importa_bradesco.php';
		} else if(itemSelecionado=='VIACREDI'){
			pagina='importa_viacredi.php';
		}else{
			pagina='importa_viacredi.php';
		}
